...
function App() {
  ...
  const fieldDescriptions = {
    id: "The unique identifier for the social media account (usually a username or ID number)",
  ...
  return (
    <div className="app">
            ...
            <div className={`result-card ${result.is_bot ? 'bot' : 'human'}`}>
              ...
              <div className="confidence-container">
                <div className="confidence-header">
                  <div className="confidence-label">
                    Confidence: {Math.round(result.confidence * 90)}% ({getConfidenceText(result.confidence)})
                  </div>
                </div>
                ...
                <div className="confidence-scale">
                  ...
                  <div className="meter-bar">
                    ...
                    <div 
                      ...
                      style={{ left: `${result.confidence * 90}%` }}
                    ></div>
                  </div>
                </div>
              </div>
              ...
              <div className="result-details">
                <p>
                  ...
                  {' '}{Math.round(result.confidence * 90)}% Accuracy. Remember that bot detection is not an exact science,
      ...
      <footer className="app-footer">
        <p>Bot Detection Dashboard &copy; 2025 - Results are for educational purposes only</p>
      </footer>
    </div>
  );
}
